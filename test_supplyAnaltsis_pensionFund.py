...
def TodaySellAndBuy(code, inDate): 
    ...
    print("연기금 code : " + code + "   date : " + inDate)
    ...
    for data in datas:
        ...
        sqlInsert = "insert into prt_studio.추세_연기금 ("
        sqlInsert += "    종목코드"
        sqlInsert += "    , 일자"
        sqlInsert += "    , 매수매도량"
        sqlInsert += "    , 누적합계"
