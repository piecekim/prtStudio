...
# 추세 국가지자체 테이블에 데이터를 insert 하기 위한 함수
def TodaySellAndBuy(code, inDate): 
    ...
    print("국가지자체 code : " + code + "    date : " + inDate)
    ...
    for data in datas:
        ...
        sql20Avg += "            A.*"
        sql20Avg += "        from"
        sql20Avg += "            prt_studio.추세_국가지자체 A"
        sql20Avg += "        where 1=1"
        ...
        sql60Avg += "            A.*"
        sql60Avg += "        from"
        sql60Avg += "            prt_studio.추세_국가지자체 A"
        sql60Avg += "        where 1=1"
        ...
        sql120Avg += "            A.*"
        sql120Avg += "        from"
        sql120Avg += "            prt_studio.추세_국가지자체 A"
        sql120Avg += "        where 1=1"
        ...
        sql240Avg += "            A.*"
        sql240Avg += "        from"
        sql240Avg += "            prt_studio.추세_국가지자체 A"
        sql240Avg += "        where 1=1"
        ...
        sqlInsert = "insert into prt_studio.추세_국가지자체 ("
        sqlInsert += "    종목코드"
        sqlInsert += "    , 일자"
        sqlInsert += "    , 매수매도량"
        sqlInsert += "    , 누적합계"
