...
# 추세 은행 테이블에 데이터를 insert 하기 위한 함수
def TodaySellAndBuy(code, inDate): 
    ...
    for data in datas:
        ...
        sqlInsert = "insert into prt_studio.추세_은행 ("
        sqlInsert += "    종목코드"
        sqlInsert += "    , 일자"
        sqlInsert += "    , 매수매도량"
        sqlInsert += "    , 누적합계"
