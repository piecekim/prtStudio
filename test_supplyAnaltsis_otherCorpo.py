...
# 추세 기타법인 테이블에 데이터를 insert 하기 위한 함수
def TodaySellAndBuy(code, inDate): 
    ...
    print("기타법인 code : " + code + "    date : " + inDate)
    ...
    for data in datas:
        ...
        sql120Avg += "            A.*"
        sql120Avg += "        from"
        sql120Avg += "            prt_studio.추세_기타법인 A"
        sql120Avg += "        where 1=1"
        ...
        sql240Avg += "            A.*"
        sql240Avg += "        from"
        sql240Avg += "            prt_studio.추세_기타법인 A"
        sql240Avg += "        where 1=1"
        ...
        sqlInsert = "insert into prt_studio.추세_기타법인 ("
        sqlInsert += "    종목코드"
        sqlInsert += "    , 일자"
        sqlInsert += "    , 매수매도량"
        sqlInsert += "    , 누적합계"
